...
TEST_CASE("Create triangle")
{
	...
	auto shapePtr = shapeFactory->CreateShape("Triangle Green 1.0;1.0 3.0;1.0 2.0;5.0");
...
TEST_CASE("Create ellipse")
{
	auto shapeFactory = make_unique<CShapeFactory>();
	auto shapePtr = shapeFactory->CreateShape("Ellipse Blue 5.0;6.5 10.2 5.6");
...
TEST_CASE("Create regular polugon")
{
	auto shapeFactory = make_unique<CShapeFactory>();
	auto shapePtr = shapeFactory->CreateShape("Polygon Yellow 5.0;5.0 2.0 5");
